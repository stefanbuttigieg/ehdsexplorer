...
import { Languages, AlertTriangle, ChevronDown } from "lucide-react";
...
import { PlainLanguageFeedback } from "@/components/PlainLanguageFeedback";
          ...
          <Card className="border-green-500/20 bg-green-50/50 dark:bg-green-950/10">
            ...
            <CardContent>
              ...
              <div className="mt-4 pt-4 border-t border-green-500/20">
                <PlainLanguageFeedback translationId={translation.id} />
              </div>
