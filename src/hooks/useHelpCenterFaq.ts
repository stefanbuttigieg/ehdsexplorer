...
const FAQ_CATEGORIES = [
  ...
  { value: 'ehds-general', label: 'EHDS – General' },
  { value: 'ehds-primary-use', label: 'EHDS – Primary Use' },
  { value: 'ehds-ehr-systems', label: 'EHDS – EHR Systems' },
  { value: 'ehds-secondary-use', label: 'EHDS – Secondary Use' },
  { value: 'ehds-hdab', label: 'EHDS – HDABs' },
  { value: 'ehds-governance', label: 'EHDS – Governance' },
  { value: 'ehds-international', label: 'EHDS – International' },
  { value: 'ehds-legal-interplay', label: 'EHDS – Legal Interplay' },
