        ...
        <Card>
          <CardHeader>
            <div className="flex items-start gap-3">
              <Badge variant="outline" className="shrink-0 font-mono text-lg px-3 py-1">
                {faq.faq_number}
              </Badge>
              <div>
                <Badge variant="secondary" className="mb-2">{faq.chapter}</Badge>
                {faq.sub_category && (
                  <Badge variant="outline" className="mb-2 ml-2">{faq.sub_category}</Badge>
                )}
