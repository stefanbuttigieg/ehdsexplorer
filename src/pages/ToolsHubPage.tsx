...
import { ResourcesSection } from "@/components/toolkit/ResourcesSection";
import { SEOHead } from "@/components/seo";

type ActiveTool = "starter-kit" | "readiness" | "resources" | null;
  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Interactive tools to assess your EHDS readiness: Compliance Starter Kit wizard, Readiness Assessment scoring, and downloadable resources."
      />
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        {!activeToolId && (
          <>
            ...
            <Card
              className="group hover:border-primary/50 hover:shadow-md transition-all cursor-pointer mb-10"
              onClick={() => setActiveToolId("resources")}
            >
              <CardContent className="py-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Templates, checklists, guides, and frameworks to support your EHDS compliance journey
                    </p>
                  </div>
        ...
        {activeToolId && (
          <div className="mb-10">
            ...
            {activeToolId === "resources" && <ResourcesSection />}
          </div>
        )}
      </div>
    </Layout>
